    ...
    Rt = class {
        ...
        async stop() {
            if (
                ...
                return (
                    he('library is already stopping'),
                    this.libraryStoppingPromise
                )
            if (!this.libraryStarted) return
            let t = async () => {
...
${a.backtrace}`,
        ...
        getExternalAdapterError(t) {
            if (t.error_code === Ba && this.config.adapter) {
                ...
                return (
                    qt(n, 'External error with reported id was not registered'),
                    n
                )
            }
        }
...
var Yr =
        ...
        (r) => {
            ...
            if (bi(r))
                ...
                let [o, ...s] = r
                ;(n = o),
                    (i = { values: rt(s || []), __prismaRawParameters__: !0 })
            } else
                switch (t) {
                    case 'sqlite':
                    case 'mysql': {
                ...
                if (
                    ...
                    (this._engineConfig = {
                        ...
                        transactionOptions: {
                            ...
                            isolationLevel:
                                u.transactionOptions?.isolationLevel,
                        },
                        logEmitter: i,
