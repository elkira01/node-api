...
R.minus = R.sub = function (e) {
    ...
    if (
        ((r = te(e.e / I)), (g = te(S.e / I)), (u = u.slice()), (o = g - r), o)
    ) {
        for (
            h = o < 0,
                h
        ...
        for (
            n = u.length, s = P.length, h = n < s, h && (s = n), n = 0;
            n < s;
            n++
        )
            if (u[n] != P[n]) {
...
R.plus = R.add = function (e) {
    ...
    if (
        ((o = te(h.e / I)), (n = te(e.e / I)), (u = u.slice()), (i = o - n), i)
    ) {
        for (
            i < 0
                ? ((r = u), (i = -i), (s = g.length))
...
${a.backtrace}`,
        ...
        getExternalAdapterError(t) {
            if (t.error_code === Xc && this.config.adapter) {
                ...
                return (
                    ar(n, 'External error with reported id was not registered'),
                    n
                )
            }
        }
