...
import publicationCategoryRouter from './kernel/publication/user-interface/web/routes/category-routes'
import publicationRouter from './kernel/publication/user-interface/web/routes/publication-routes'
